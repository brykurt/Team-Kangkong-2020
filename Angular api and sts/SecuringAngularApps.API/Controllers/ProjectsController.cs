...
namespace SecuringAngularApps.API.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        public IEnumerable<Project> GetProjects()
        {
            ...
            if(this.User.FindFirstValue(JwtClaimTypes.Role) == "Admin")
            {
            ...
            else
            {
                ...
                List<int> userProjectIds = _context.UserPermissions
                                    .Where(up => up.UserProfileId == userId && up.ProjectId.HasValue)
        ...
        public async Task<IActionResult> AddMilestone([FromBody] Milestone milestone)
        {
            ...
            //added checking for permission before update/add
            if (!await MilestoneAccessCheck(milestone))
                return Forbid();
        ...
        public async Task<IActionResult> DeleteMilestone(int id)
        {
            ...
            //added checking for permission before delete
        ...
        {
            var userId = this.User.FindFirstValue(JwtClaimTypes.Subject);
            var perm = await _context.UserPermissions.FirstOrDefaultAsync(up => up.UserProfileId == userId
